...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                <?php
                    $query=mysqli_query($con,"SELECT cart.*,items.* from cart,items
                    where cart.item_id=items.item_id") or die(mysqli_error($con));
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            ...
                            <a href="./includes/remove-cart.php?cart_id=<?php echo $row['cart_id']; ?>" class="btn btn-primary">Remove</a>
                            <a href="./checkout.php?item_id=<?php echo $row['item_id']; ?>" class="btn btn-primary">Checkout</a>
                        </div>
                    </div>
                </div>
                <?php
